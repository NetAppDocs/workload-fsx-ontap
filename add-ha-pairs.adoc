...
summary: "Add high-availability pairs to a file system in NetApp Workload Factory to scale out the file system." 
---
= Add HA pairs to a file system in NetApp Workload Factory
:icons: font
:imagesdir: ./media/

[.lead]
Add high-availability (HA) pairs to scale out an FSx for ONTAP second-generation Single-AZ file system in NetApp Workload Factory to increase performance and capacity. This expansion gives you more performance scalability and flexibility over first-generation file systems. 
...
. From *FSx for ONTAP* under *Information*, select the pencil icon next to *HA pairs*.
