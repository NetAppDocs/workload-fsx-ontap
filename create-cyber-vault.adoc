...
---
= Protect your FSx for ONTAP data with a cyber vault
:icons: font
:imagesdir: ./media/
...
For more information about cyber vaults and how to set up this architecture, refer to the link:https://docs.netapp.com/us-en/netapp-solutions-dataops/cyber-vault/ontap-cyber-vault-overview.html[ONTAP cyber vault documentation^].
