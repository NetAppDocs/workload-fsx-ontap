...
The initial creation of a replicated volume or backup file includes a full copy of the source data — this is called a _baseline_ transfer. Subsequent transfers contain only differential copies of the source data (the snapshot).
