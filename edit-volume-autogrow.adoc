...
---
= Enable volume autogrow in NetApp Workload Factory
:icons: font
:imagesdir: ./media/
...
Optionally, you can manually increase the volume capacity of a volume at any time using the link:adjust-volume-capacity.html[adjust volume capacity feature]. 
...
. From the Volumes tab, select the actions menu for the volume you want to modify. 
