...
* The ARN of an IAM role that gives Workload Factory the permissions needed to create an FSx for ONTAP file system. For details, refer to link:https://docs.netapp.com/us-en/workload-setup-admin/manage-credentials.html[Workload Factory Setup and administration guide to learn how to grant permissions to an account^].
