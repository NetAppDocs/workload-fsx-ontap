...
The Workload Factory console home page now embeds the Ask me AI assistant, enabling you to ask questions about your own storage estate and get personalized insights directly from your environment. You can interact with Ask me to understand your workloads, troubleshoot issues, and learn more about Workload Factory — all without leaving the console.
