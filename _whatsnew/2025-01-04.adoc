...
==== Support for FlexVol volumes containing block devices
You can enable ARP/AI on FlexVol volumes that contain block devices. Enabling ARP detects ransomware attacks using AI and aids in data recovery. 