...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html^[Connect to an FSx for ONTAP file system with a Lambda link]
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/manage-cifs-share.html#create-a-cifs-share-for-a-volume[Create a CIFS share for a volume]
