...
* Inactive block devices: displays if any block devices haven't been used for seven consecutive days, helping you identify and manage unused resources effectively. From here, you can link:https://docs.netapp.com/us-en/workload-fsx-ontap/manage-block-storage.html#archive-the-data-of-an-inactive-block-device[reclaim space for unused block devices].
