...
summary: "Manage the NFS export policy for a volume that uses NFSv3 or NFSv4.1 protocol types in NetApp Workload Factory." 
---
...
. From the Volumes tab, select the actions menu for the volume to change the NFS export policy for. 
