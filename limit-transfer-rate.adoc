...
summary: "Limit the max transfer rate of a replication relationship in NetApp Workload Factory." 
---
= Limit replication transfer rate in NetApp Workload Factory
:icons: font
:imagesdir: ./media/
