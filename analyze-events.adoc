...
=== View events
To view latency events, you must link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[grant _view, planning, and analysis_ permissions^] in your AWS account.

To view EMS events, you must also link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html[connect to the file system using a link].
