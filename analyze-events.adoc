...
The event analyzer automatically extracts error, alert, and emergency EMS events and latency events from FSx for ONTAP file systems. You can view events without a link connection by link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[granting _view, planning, and analysis_ permissions^] in your AWS account. To analyze events and receive AI-powered insights, you must link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html[connect to the file system using a link]. Events are displayed for 72 hours before removal.
...
=== View events
To view events, you must link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[grant _view, planning, and analysis_ permissions^] in your AWS account.

=== Analyze events
To analyze events and receive AI-powered insights and recommendations, ensure the following:
