...
The event analyzer extracts FSx for ONTAP EMS events and analyzes them to help you maintain the health and performance of FSx for ONTAP file systems. *The events are from the last 72 hours or Events are removed after 72 hours.*
