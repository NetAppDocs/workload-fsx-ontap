...
+ 
These permissions allow Workload Factory to invoke Bedrock models for proactive error investigation and remediation. This profile also ensures secure AI access for tailored insights.
+
Also ensure that AWS credentials have the following permissions associated with Workload Factory. 
+
