...
. From *FSx for ONTAP*, select the three-dot menu of the file system to associate a link to and then select *Manage*. 
...
+
Existing links appear on the Links page.
. From the Links page, select the three-dot menu of the link to remove and then select *Remove*.
+
