...
. Select *Manage*. 
. Under Information, select the pencil icon next to *Capacity management*. The pencil icon appears next to the drop down arrow when the mouse hovers over the *Capacity management* row. 
...
* *Adaptive mode*: predicts and adjusts capacity based on historical data. 
+
