...
---
= Protect your FSx for ONTAP data with NetApp Autonomous Ransomware Protection with AI
:icons: font
:imagesdir: ./media/
...
.Before you begin
To enable ARP/AI for a file system or a volume, you must associate a link. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html[Learn how to associate an existing link or to create and associate a new link^]. After the link associates, return to this operation.
...
. Select the actions menu of the volume to enable ARP/AI, then *Data protection actions*, and then *Manage ARP/AI*.
