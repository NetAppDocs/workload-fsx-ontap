...
. From *FSx for ONTAP*, select the actions menu of the file system and then select *Manage*.
. In the file system overview under Storage VMs, select *Create storage VM*.
. On the Create storage VM page, under Storage VM configuration, provide the following: 
