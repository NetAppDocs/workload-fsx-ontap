...
---
= Manually adjust file system capacity in NetApp Workload Factory
:icons: font
:imagesdir: ./media/
...
Alternatively, you can link:manage-capacity-automatically.html[enable automatic capacity management] so Workload Factory manages file system capacity for you. 
