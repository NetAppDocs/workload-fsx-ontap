...
* *Terraform BlueXP Workload Factory Provider*: the Terraform provider (provide link) lets you build and manage infrastructure workflows generated in the Workload Factory console.
