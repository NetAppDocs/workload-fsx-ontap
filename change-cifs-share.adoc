...
---
= Change the CIFS share for a volume in BlueXP workload factory
:icons: font
:imagesdir: ./media/

[.lead]
Changing a volume's CIFS share in BlueXP workload factory involves determining the users and groups to give access to and the type of access to give them.
