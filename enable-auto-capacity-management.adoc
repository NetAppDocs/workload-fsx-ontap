...
* You must have link:link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[credentials with _operations and remediation_ permissions^] in Workload Factory to complete this task.
