...
. From *FSx for ONTAP*, select the actions menu of the file system with the volume clone to split and then select *Manage*.  
. From the file system overview, select the *Volumes* tab. 
. In the Volumes tab, select the actions menu of the volume with the cloned volume to split. 
