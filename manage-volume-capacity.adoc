...
* To check the balance of a volume, you must link:link:https://docs.netapp.com/us-en/workload-setup-admin/manage-links.html[associate a link^]. If you don't have an existing link, link:link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html[create a link^]. To associate a link in the file system, select *Associate link* under *Account name*. After the link associates, return to this operation.  
...
* To rebalance a volume, you must link:link:https://docs.netapp.com/us-en/workload-setup-admin/manage-links.html[associate a link^]. If you don't have an existing link, link:link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html[create a link^]. To associate a link in the file system, select *Associate link* under *Account name*. After the link associates, return to this operation. 
