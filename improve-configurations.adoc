...
* Cost optimization: storage efficiencies, data tiering, unnecessary snapshot and backup deletion, inactive block devices, inactive NAS volumes, underutilized file system
