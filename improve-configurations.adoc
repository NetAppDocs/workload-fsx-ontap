...
* Operational excellence: automatic capacity management, volume file capacity utilization threshold, volume utilization nearing full, and cache relationship write mode
* Cost optimization: storage efficiencies, data tiering, unnecessary snapshot and backup deletion
