...
* Security: NetApp Autonomous Ransomware Protection with AI (ARP/AI) and unauthorized access to volumes
...
* Performance optimization: FlexGroup volumes rebalance
...
.Before you begin
* You must link:link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[grant _operations and remediation_ permissions^] in your AWS account. 
