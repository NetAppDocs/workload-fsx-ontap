...
* Reliability: SSD capacity threshold, scheduled local snapshots, schedule volume backups, remote data replication, data reliability for long-term retention, and connect host to failover node
...
* Performance optimization: connect host to preferred node
