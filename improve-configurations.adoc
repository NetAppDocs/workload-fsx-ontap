...
* Reliability: SSD capacity threshold, scheduled local snapshots, schedule volume backups, remote data replication, data reliability for long-term retention, and connect hosts to failover node
...
* Performance optimization: connect hosts to preferred node
