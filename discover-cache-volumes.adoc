...
---
= Discover cache volumes in NetApp Workload Factory
:icons: font
:imagesdir: ./media/
...
* You must associate a link to discover cache relationships on a file system. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html[Learn how to associate an existing link or to create and associate a new link^]. After the link associates, return to this operation.
