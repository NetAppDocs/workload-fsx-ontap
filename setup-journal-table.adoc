...
* Set network configuration to *Internet* for the S3 access point. link:edit-s3-access-points.html[Edit network configuration for the S3 access point].
* link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[Grant the _operations and remediation_ permissions^] to your Workload Factory credentials.
...
If any of the steps fail, <<Troubleshoot the infrastructure setup for the journal table,troubleshoot the infrastructure setup for the journal table>> or contact NetApp support for assistance.
