...
. Select the menu image:workload-menu-icon.png["The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration"] and then select *Storage*.
...
. From the Storage VMs tab, select the actions menu of the storage VM to replicate an SVM for.
