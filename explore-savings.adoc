...
* Make sure you link:https://docs.netapp.com/us-en/workload-setup-admin/manage-credentials.html#grant-permissions[grant _Automate_ permissions^] in your AWS account to detect AWS Elastic Block Store (EBS), Elastic File Store (EFS), and FSx for Windows File Server storage environments. 
