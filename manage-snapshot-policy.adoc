...
You can assign a snapshot policy to a single volume, a single storage VM, or all storage VMs in an FSx for ONTAP file system. *Rachel - if you include all these options, you should include instructions for all of them. Do you have the instructions for all?*
