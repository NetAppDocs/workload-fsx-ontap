...
. Select the actions menu for the volume with the snapshot to edit.
...
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Storage*. 
. From the Storage menu, select *Volumes explorer*. 
. Select the actions menu for the volume with the snapshot to access.
. Select *Data protection actions* and then *Manage snapshots*. 
...
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Storage*. 
. From the Storage menu, select *Volumes explorer*. 
. Select the actions menu for the volume with the snapshot to delete.
. Select *Data protection actions* and then *Manage snapshots*. 
