...
. From the Storage menu, select *Volume explorer*. 
. From *Volume explorer*, select *Create volume*. 
...
+
The following are default policies from AWS. To display existing snapshot policies, you must link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html[associate a link]. 
+
