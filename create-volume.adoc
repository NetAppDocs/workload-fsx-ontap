...
+
* *Block access*: allows hosts running critical business applications access to the volume using the iSCSI protocol. This access option is only available when the file system scale-out deployment has 6 HA pairs or fewer. 
+
