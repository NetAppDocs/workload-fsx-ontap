...
.. *Initialize replication relationship*: Select to initialize the replication relationship immediately after creating the replication or later. Refer to the instructions to<<initialize manually later,Step 2: Initialize the replication relationship>>
