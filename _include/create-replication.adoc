...
.. *Initialize replication relationship*: Choose to initialize the replication relationship immediately after creating the replication or later. Note that initialization can be time-consuming, and you might want to run the baseline transfer in off-peak hours.
+ 
