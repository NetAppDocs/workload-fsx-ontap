...
.About this task
Replication protects your data if a disaster affects your region.

This operation creates a replication relationship for source volumes in an FSx for ONTAP file system or an on-premises ONTAP system. 
