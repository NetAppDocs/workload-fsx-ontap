...
* *Cache (ONTAP FlexCache 9.17.x or below) volumes*: Source storage VMs that contain cache volumes aren't supported for cutover. Remove the ONTAP FlexCache relationship before cutover to avoid migration failures.
