...
* Volumes with S3 access points: Cut over replication for migration use cases isn't supported for volumes with S3 access points. 

.Before you begin
Review these requirements before you begin.

* Delete any S3 access points on the source volume before you cut over replication.
