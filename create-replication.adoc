...
2. <<Cut over replication,cut over replication>> to permanently migrate data and configuration settings from the source file system to the target FSx for ONTAP file system.
