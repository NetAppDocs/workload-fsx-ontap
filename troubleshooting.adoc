...
Refer to link:https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/troubleshooting.html[“Troubleshooting Amazon FSx for NetApp ONTAP” documentation^] for more information. 
